module github.com/teonet-go/teoproxy/cmd/websocket/client-gui/serve
...
require (
	...
	github.com/teonet-go/teoproxy/teonet/server v0.0.0-00010101000000-000000000000 // indirect
